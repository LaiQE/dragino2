...
define Device/dragino2
  ...
  CONSOLE := ttyATH0,115200
  DEVICE_PACKAGES := \
  	kmod-usb-core kmod-usb2 kmod-usb-ledtrig-usbport wget curl \
	bind-client openssl-util fdisk wol gzip xz unrar tar usbutils fstools ip-full bash \
	nfs-utils nfs-kernel-server nfs-kernel-server-utils mount-utils kmod-fs-nfs-common \
	kmod-fs-nfs-v4 kmod-fs-ext4 kmod-fs-msdos kmod-nls-cp437 kmod-nls-iso8859-1 \
	kmod-nls-utf8 kmod-usb-storage-extras kmod-usb-storage kmod-usb-core vsftpd-tls \
	unzip e2fsprogs nfs-utils kmod-fs-cifs kmod-fs-f2fs kmod-fs-ntfs kmod-pptp \
	ppp-mod-pptp kmod-nf-nathelper-extra vlmcsd node node-npm
